        ...
        <Card variant="elevated">
          <CardBody className="p-8 space-y-6">
            ...
            <section>
              ...
              <p className="text-gray-700">
                LibreBlog se proporciona &ldquo;tal cual&rdquo; sin garantías de ningún tipo. No seremos responsables de daños indirectos, incidentales o consecuentes derivados del uso de la plataforma.
              </p>
            </section>
